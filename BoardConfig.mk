...
ifneq (,$(filter %xqbq52,$(TARGET_PRODUCT)))
TARGET_BOOTLOADER_BOARD_NAME := XQ-BQ52
else
TARGET_BOOTLOADER_BOARD_NAME := XQ-BQ52
...
# Kernel cmdline
BOARD_KERNEL_CMDLINE += androidboot.hardware=pdx214
BOARD_KERNEL_CMDLINE += androidboot.fstab_suffix=pdx214
...
# Reserve space for data encryption (0x1919f5f00-0x4000)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 107809714176
